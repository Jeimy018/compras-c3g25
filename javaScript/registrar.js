...
console.log(listaProductos); */
        ...
        function saludar(nombre, edad){
            ...
            return `Hola ${nombre} mundo desde la funcion, ${estado}`;
        }
        ...
        const saludar_abreviado=(nombre)=>`Hola ${nombre} mundo desde la funcion`;

        let mensaje = saludar_abreviado("juan", 19);
...
do{
    ...
    compra.cantidad = parseInt(prompt("Escriba  la cantidad que desaa llevar..."));
    compra.envio = parseInt(prompt("Seleccione el tipo de envio 1.Express/2. Normal"));
